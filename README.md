...
```bash
pip install git+https://github.com/notcammy/PyInstaLive.git@3.1.5 --process-dependency-links
```
...
```bash
pip install git+https://github.com/notcammy/PyInstaLive.git@3.1.5 --process-dependency-links --upgrade
```
