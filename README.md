# PyInstaLive
![Version 2.4.3](https://img.shields.io/badge/Version-2.4.3-pink.svg?style=for-the-badge)
...
```bash
pip install git+https://github.com/notcammy/PyInstaLive.git@2.4.3 --process-dependency-links
```

#### Updating

To update PyInstaLive to the latest version (currently **2.4.3**) run the following command:

```bash
pip install git+https://github.com/notcammy/PyInstaLive.git@2.4.3 --process-dependency-links --upgrade
```
...
```
----------------------------------------------------------------------
PYINSTALIVE (SCRIPT V2.4.3 - PYTHON V3.6.3) - 06:45:30 PM
----------------------------------------------------------------------
